  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="dashboard-card">
        <h3 className="text-lg font-medium text-dashboard-text mb-2">Discount Simulator</h3>
        <p className="text-sm text-dashboard-secondaryText mb-4">
          Simulates the impact of different discount levels on sales volume and revenue based on price elasticity.
        </p>
      ...
      <div className="dashboard-card mt-6">
        <h3 className="text-lg font-medium text-dashboard-text mb-2">Promotion ROI by Discount Level</h3>
        <p className="text-sm text-dashboard-secondaryText mb-4">
          Shows how different discount percentages affect revenue. The curve peaks at the optimal discount level.
        </p>
